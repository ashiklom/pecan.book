...
h2. Basic Roxygen2 instructions:
...
h3. "Tags":http://cran.r-project.org/doc/manuals/R-exts.html#Documenting-functions
...
h4. "Formatting":http://cran.r-project.org/doc/manuals/R-exts.html#Marking-text

* @\bold{}@
* @\emph{}@ italics


h4. "Links":http://cran.r-project.org/doc/manuals/R-exts.html#Marking-text
...
h4. "Math":http://cran.r-project.org/doc/manuals/R-exts.html#Mathematics
...
h4. "Lists":http://cran.r-project.org/doc/manuals/R-exts.html#Lists-and-tables
...
h4. "Tables":http://cran.r-project.org/doc/manuals/R-exts.html#Lists-and-tables
...
** the document function is a shortcut to using roxygenize:
<pre>
require(roxygen2)
roxygenize("common")
</pre>
...
<pre>
echo -e 'require(roxygen2)\nroxygenize("common")' | R --vanilla
</pre>
* Commit changes
** changes to documentation will often be associated with other fixes and additional tests,  
** if present, add new .Rd files to bzr repository
<pre>
bzr add man/
bzr commit -m "added documentation to package foo" man/*
</pre>
** otherwise 
<pre>
bzr commit -m "updated documentation to package foo" man/*
</pre>