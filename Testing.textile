...
git checkout goat-cheddar</code></pre>
...
* instructions for installing this are available on the "VM creation wiki":https://github.com/PecanProject/pecan/wiki/VM-Creation)
