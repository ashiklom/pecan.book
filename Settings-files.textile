h1. Example Settings Files

* ED2
** ED2IN template (Fortran Namelist): [models/ed/inst/ED2IN.r86], [models/ed/inst/ED2IN.r46]
** example settings file (see below)
* SIPNET: 
** sipnet.in: [models/sipnet/inst/sipnet.in]
** pecan settings: [utils/inst/extdata/test.settings.xml] (this is the 'standard' used for testing)
* BIOCRO: 
